...
Classes:
    ...
    PortExpenses: The fees that shipping operators and their customers pay to port
        authorities for the use of the port's facilities and services.
    CanalExpenses: The fees that shipping operators and their customers pay to canal
